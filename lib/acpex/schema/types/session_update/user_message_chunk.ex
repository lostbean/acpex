defmodule ACPex.Schema.Types.SessionUpdate.UserMessageChunk do
  @moduledoc """
  User message chunk update.

  Represents a streaming chunk of user message content.

  ## Required Fields

    * `type` - Always "user_message_chunk" for this variant
  ...
  @primary_key false
  embedded_schema do
    field(:type, :string, default: "user_message_chunk")
  ...
  The `type` field defaults to "user_message_chunk".
  """
  ...
  def changeset(struct \\ %__MODULE__{}, params) do
    ...
    |> validate_inclusion(:type, ["user_message_chunk"])
  end
