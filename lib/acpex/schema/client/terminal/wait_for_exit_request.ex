defmodule ACPex.Schema.Client.Terminal.WaitForExitRequest do
  @moduledoc """
  Request from agent to wait for terminal exit.

  Sent by the agent to request the client to wait for a terminal process
  to exit and return its exit status. This is a bidirectional request
  (agent → client).
  ...
  ## Example
      ...
      %ACPex.Schema.Client.Terminal.WaitForExitRequest{
