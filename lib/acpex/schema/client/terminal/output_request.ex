defmodule ACPex.Schema.Client.Terminal.OutputRequest do
  @moduledoc """
  Request from agent to get terminal output.

  Sent by the agent to request the client to retrieve output from a running
  terminal. This is a bidirectional request (agent → client).
  ...
  ## Example
      ...
      %ACPex.Schema.Client.Terminal.OutputRequest{
