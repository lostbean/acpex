defmodule ACPex.Schema.Client.Terminal.ReleaseRequest do
  @moduledoc """
  Request from agent to release a terminal.

  Sent by the agent to request the client to release resources associated
  with a terminal. This is a bidirectional request (agent → client).
  ...
  ## Example
      ...
      %ACPex.Schema.Client.Terminal.ReleaseRequest{
